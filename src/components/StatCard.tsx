...
export function StatCard({ title, value, suffix, icon, delay = 0 }: StatCardProps) {
  return (
    <motion.div 
      ...
      transition={{ delay }}
      className="h-full p-5 bg-white/60 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl flex flex-col items-center justify-center text-center backdrop-blur-sm hover:bg-zinc-50 dark:hover:bg-zinc-900/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-md shadow-sm dark:shadow-none"
    >
